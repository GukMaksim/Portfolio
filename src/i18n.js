      ...
      timeline: [
        ...
        },
        {
          ...
          responsibilities: [
            ...
            'Забезпечення працездатності комп\'ютерної техніки',
        ...
        },
        {
          ...
          description: '',
          responsibilities: [
            'Програмно-технічне забезпечення працездатності комп\'ютерної техніки, каналів зв\'язку та організація інформаційних потоків торгових підрозділів мережі ресторанів',
            'Інформаційна підтримка ресторанів мережі',
            'Оперативний аналіз торговельної діяльності підприємства',
            'Планування бюджету із закупівлі та модернізації комп\'ютерної техніки для співробітників',
...
export function t(key) {
  const result = key.split('.').reduce((obj, k) => obj?.[k], messages[locale.value])
  return result ?? key
}
